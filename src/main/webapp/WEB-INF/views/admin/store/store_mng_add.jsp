  ...
  <section id="container">
    ...
    <section id="main-content">
      ...
      <section class="wrapper site-min-height">
        <h3 style="margin-bottom: 5px;"><i class="fa fa-angle-right"></i> 매장 등록</h3>
            ...
            <div class="form-panel" style="margin-top:0; padding-bottom: 38px; border-radius: 0 0 10px 10px;">
              <form class="form-horizontal style-form" method="get">
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input class="form-control" type="text" placeholder="매장명">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-2" >
                    <input class="form-control" id="post__code" type="text" placeholder="우편번호">
                  </div>
                  <div class="col-sm-6">
                    <input class="form-control" id="road__Address" type="text" placeholder="서울시 종로구 삼일대로28길 14">
                  </div>
                  ...
                  <div class="col-sm-2"> &nbsp;</div>
                  <div class="col-sm-3" >
                    <input class="form-control" id="extra__Address" type="text" placeholder="동">
                  </div>
                  <div class="col-sm-4" >
                    <input class="form-control" id="detail__Address" type="text" placeholder="상세주소">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">전화번호</label>
                  <div class="col-sm-4">
                    <input class="form-control" type="text" placeholder="0212345678">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label" >이메일</label>
                  <div class="col-sm-5">
                    <input class="form-control" type="email" placeholder="walking@walking.com">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label" style="padding: 25px 15px;">서류</label>
                  <div class="col-sm-2" style="margin-top: 2px; padding:0 0 0 15px;">
                    <input class="grey__button" type="button" onclick="" value="사업자등록증" style="margin-right: 5px;">
                  </div>
                  <div class="col-lg-4" style="padding: 0;">
                    <input id="" type="file" class="grey__button" value="수정" name="">
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input class="form-control round-form" type="time" value="09:00"
                      style="width: 20%;display: inline-block;margin-right: 10px;"> ~
                    <input class="form-control round-form" type="time" value="21:00"
                      ...
                      <div class="project">
                        <div class="photo-wrapper_">
                          <div class="photo store_image_small">
                            <img class="img-responsive" src="resources/assets/images/admin/upload-photo-icon.png" alt=""></a>
                          </div>
                  ...
                  <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 desc">
                    <div class="project-wrapper">
                      <div class="project">
                        <div class="photo-wrapper_">
                          <div class="photo store_image_small">
                            <img class="img-responsive center-block" src="resources/assets/images/admin/upload-photo-icon.png" alt=""></a>
                          </div>
                          <div class="overlay"></div>
                        </div>
                      </div>
