			...
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<div class="order_alert"
						style="background-color: rgba(167, 161, 161, 0.425); border-radius: 10px; padding: 15px; margin: 0 40px 0 50px;">
			...
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12"
					...
					<div id="daumRoughmapContainer1649752833849"
						...
						style="width: 90%; margin: 10px 30px 10px 50px;">
