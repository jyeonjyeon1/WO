...
<%@ include file="../inc/admin_allmenu.jsp" %> 
      ...
      <section class="wrapper site-min-height">
        ...
        <a type="button" class="btn btn-theme" href="policy_add.admin"
        style="margin-left:20px;margin-top:10px;width:100px;float: left;">정책등록</a>
                ...
                <div class="dataTable-container">
                  <table id="datatablesSimple">
                    ...
                    <tr id="deleteForm${vs.index }">
                        ...
                        <td><fmt:formatDate value="${policyList.t_regdate }" pattern="yy-MM-dd a hh:mm:ss"/></td>
                        <td><fmt:formatDate value="${policyList.t_regdate }" pattern="yy-MM-dd a hh:mm:ss"/></td>
                        <td>
