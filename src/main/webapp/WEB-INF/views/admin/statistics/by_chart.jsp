    ...
    <!-- allmenu import -->
      ...
      <section class="wrapper">
        ...
        <div class="row mt">
          <div class="col-lg-12">
            <div class="content-panel">
              <h4><i class="fa fa-angle-right"></i> 5월 일별 매출</h4>
              <section id="unseen">
                <table class="table table-bordered table-striped table-condensed" style="">
                  <thead>
                    <tr>
                      <th>번호</th>
                      <th>날짜</th>
                      <th class="numeric">주문수</th>
                      <th class="numeric">주문금액 (원)</th>
                    </tr>
                  </thead>
                  <tbody>
                  <c:forEach var="dailySales" items="${dailySales }" varStatus="vs">
                  <c:if test="${(dailySales.o__date).indexOf('2022-05') ne -1 }">
                    <tr>
                      <td class="numeric">${vs.count}</td>
                      <td class="numeric">${dailySales.o__date }</td>
                      <td class="numeric">${dailySales.o_seq }</td>
                      <td class="numeric"><fmt:formatNumber value="${dailySales.o_total_price }" pattern="###,###"/></td>
                    </tr>
                    </c:if>
                  </c:forEach>
                  </tbody>
        ...
        <div class="row mt">
          <div class="col-lg-12">
            <div class="content-panel">
              <h4><i class="fa fa-angle-right"></i> 5월 매장 Top 5</h4>
                ...
                <table class="table table-bordered table-striped table-condensed cf">
                  <thead class="cf">
                    <tr>
                      ...
                      <th>매장명</th>
                      <th class="numeric">주문수</th>
                      <th class="numeric">주문금액</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                      <td data-title="Code">1</td>
                      <td data-title="Company">와츠롱 커피</td>
                      <td class="numeric" data-title="Price">323</td>
                      <td class="numeric" data-title="Change">2,544,000 원</td>
                    </tr>
                    <tr>
                     <td data-title="Code">2</td>
                      <td data-title="Company">지현이네 농장</td>
                      <td class="numeric" data-title="Price">299</td>
                      <td class="numeric" data-title="Change">2,324,100 원</td>
                    </tr>
                    <tr>
                      <td data-title="Code">3</td>
                      <td data-title="Company">반쥴</td>
                      <td class="numeric" data-title="Price">321</td>
                      <td class="numeric" data-title="Change">2,245,500 원</td>
                    </tr>
                    <tr>
                     <td data-title="Code">4</td>
                      <td data-title="Company">스타벅스 종로점</td>
                      <td class="numeric" data-title="Price">234</td>
                      <td class="numeric" data-title="Change">1,945,500 원</td>
                    </tr>
                    <tr>
                     <td data-title="Code">5</td>
                      <td data-title="Company">틈 종로점</td>
                      <td class="numeric" data-title="Price">276</td>
                      <td class="numeric" data-title="Change">2,105,500 원</td>
                    </tr>
                  </tbody>
                </table>
              </section>
