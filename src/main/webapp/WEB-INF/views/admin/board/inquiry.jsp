        ...
        *********************************************************************************************************************************************************** -->
		...
		<header class="header black-bg">
			<div class="sidebar-toggle-box">
				<div class="openup tooltips" style="background-image: url(resources/assets/images/admin/logo/logo_white.svg);" data-placement="right"
				...
				<ul class="sidebar-menu" id="nav-accordion">
					...
					<li class="sub-menu dcjq-parent-li"><a id="board-manage"
						...
						<ul class="sub">
							...
							<li class="active"><a id="inquiry" href="inquiry.admin">1:1
									문의</a></li>
						</ul></li>
		...
		<section id="main-content">
			...
			<section class="wrapper">
				<h3 style="margin-bottom: 0;">
					<i class="fa fa-angle-right"></i> 1:1 문의
				</h3>
				<!-- BASIC FORM ELELEMNTS -->
				<div class="row mt">
					<div class="col-lg-12">
						<div class="card-header" style="margin-top: 0; font-size: 16px;">
							<i class="fa fa-search" style="font-size: 14px;"></i> 문의 검색
						</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<label class="checkbox-inline"> <input type="checkbox"
											...
											type="checkbox" id="inlineCheckbox3" value="option2" checked>
											미답변
										</label> <label class="checkbox-inline"> <input
											type="checkbox" id="inlineCheckbox4" value="option2" checked>
											임시저장
										</label>
								...
								<thead>
									<tr>
										...
										<th data-sortable="" style="width: 15%;"><a href="#"
											class="dataTable-sorter">문의일시</a></th>
										<th data-sortable="" style="width: 15%;"><a href="#"
											class="dataTable-sorter">답변일시</a></th>
									</tr>
								</thead>
