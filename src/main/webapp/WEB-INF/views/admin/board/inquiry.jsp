  ...
  <section id="container">
    ...
    <section id="main-content">
      ...
      <section class="wrapper">
        <h3 style="margin-bottom: 0;"><i class="fa fa-angle-right"></i> 1:1 문의</h3>
            ...
            <div class="form-panel" style="margin-top:0; padding-bottom: 38px;">
              <form class="form-horizontal style-form" method="get">
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">문의자</label>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <label class="checkbox-inline">
                      <input type="checkbox" id="inlineCheckbox2" value="option2" checked> 답변완료
                    </label>
                    <label class="checkbox-inline">
                      <input type="checkbox" id="inlineCheckbox3" value="option2" checked> 미답변
                    </label>
                    <label class="checkbox-inline">
                      <input type="checkbox" id="inlineCheckbox4" value="option2" checked> 임시저장
                    </label>
              ...
              <table id="datatablesSimple">
                <thead>
                  <tr>
                    ...
                    <th data-sortable="" style="width: 20%;"><a href="#" class="dataTable-sorter">제목</a></th>
                    ...
                    <th data-sortable="" style="width: 10%;"><a href="#" class="dataTable-sorter">전화번호</a></th>
                    <th data-sortable="" style="width: 10%;"><a href="#" class="dataTable-sorter">상태</a></th>
                    <th data-sortable="" style="width: 15%;"><a href="#" class="dataTable-sorter">문의일시</a></th>
                    <th data-sortable="" style="width: 15%;"><a href="#" class="dataTable-sorter">답변일시</a></th>
                  </tr>
                </thead>
