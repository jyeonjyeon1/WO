  ...
  <section id="container">
    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="active"><a id="point-mng" href="point_mng.admin">포인트 관리</a></li>
    ...
    <%@ include file="../inc/admin_allmenu.jsp" %>
      <section class="wrapper site-min-height">
        <h3><i class="fa fa-angle-right"></i> 포인트 관리</h3>
        <div class="row mt">
          <div class="col-lg-12">
            ...
            <div class="form-panel" style="margin: 0 10px; padding-bottom: 38px;">
              <form class="form-horizontal style-form" method="get">
                ...
                <a href="javascript:;" class="btn btn-theme point_select"
                  style="font-size: 12px; width:90px;float: left;">
                  포인트 설정
                </a>
                  ...
                  <table id="datatablesSimple">
                    <thead>
                      <tr>
                        ...
                        <th data-sortable="" style="width: 15%;"><a href="#" class="dataTable-sorter">날짜</a></th>
                        <th data-sortable="" style="width: 10%;"><a href="#" class="dataTable-sorter">아이디</a></th>
                        <th data-sortable="" style="width: 8%;"><a href="#" class="dataTable-sorter">이름</a></th>
                        <th data-sortable="" style="width: 8%;"><a href="#" class="dataTable-sorter">유형</a></th>
                        <th data-sortable="" style="width: 20%;"><a href="#" class="dataTable-sorter">내용</a></th>
                        <th data-sortable="" style="width: 8%;"><a href="#" class="dataTable-sorter">처리자</a></th>
                        <th data-sortable="" style="width: 10%;"><a href="#" class="dataTable-sorter">잔여포인트</a></th>
                      </tr>
                    </thead>
