  ...
  <section id="container">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu dcjq-parent-li">
            ...
            <ul class="sub">
              ...
              <li class="active"><a id="store-pending" href="store_pending.admin">승인 대기</a></li>
    ...
    <%@ include file="../inc/admin_allmenu.jsp" %>
      <section class="wrapper"> 
        <h3 style="margin-bottom: 0;"><i class="fa fa-angle-right"></i> 입점 승인 대기</h3>
            ...
            <div class="form-panel" style="margin-top:0; padding-bottom: 38px;">
              <form class="form-horizontal style-form" method="get">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" placeholder="메가커피" style="width: 30%;">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">전화번호</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" placeholder="0212345678 " style="width: 30%;">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">이메일</label>
                  <div class="col-sm-10">
                    <input type="email" class="form-control" placeholder="gildong@wo.com " style="width: 30%;">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">담당자</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" placeholder="홍길동 " style="width: 20%;">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <table id="datatablesSimple">
                    <thead>
                      <tr>
                        ...
                        <th data-sortable="" style="width: 10%;"><a href="#" class="dataTable-sorter">사업자</a></th>
                        ...
                        <th data-sortable="" style="width: 10%;"><a href="#" class="dataTable-sorter">담당자</a></th>
                        <th data-sortable="" style="width: 10%;"><a href="#" class="dataTable-sorter">상태</a></th>
                        <th data-sortable="" style="width: 15%;"><a href="#" class="dataTable-sorter">신청일</a></th>
                        <th data-sortable="" style="width: 10%;"><a href="#" class="dataTable-sorter">설정</a></th>
                      </tr>
                    </thead>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <a data-toggle="modal" href="store_mng.html#myModal" class="btn btn-success btn-xs"><i class="fa fa-eye"></i></a>
                          <button onclick="location.href='store_mng_update.admin?code=8868500662'" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></button>
                      ...
                      <tr>
                        ...
                        <td>
                          <a data-toggle="modal" href="store_mng.html#myModal" class="btn btn-success btn-xs"><i class="fa fa-eye"></i></a>
                          <button onclick="location.href='store_mng_update.admin'" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></button>
