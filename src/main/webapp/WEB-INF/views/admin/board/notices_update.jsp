              ...
              <form class="form-horizontal style-form" method="get">
                <div class="form-group">
                  ...
                  <div class="col-sm-4 col-sm-4 col-sm-4">
                    <input type="text" class="form-control round-form" value="125" disabled>
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">글제목</label>
                  <div class="col-sm-6">
                    <input class="form-control" type="text" value="제목이시다">
                  </div>
                  <!--
...
가나다라마바사아자차카타파사<br>
                ...
                <button type="button" onclick="location.href='notices.html'" class="btn btn-theme"
