        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu dcjq-parent-li">
            ...
            <ul class="sub">
              ...
              <li class="active"><a id="mess-send-group" href="mess_send_group.admin">단체 문자 전송</a></li>
    ...
    <section id="main-content"> 
     <form class="allmenu-form">
      ...
      <section class="wrapper site-min-height">
        <h3><i class="fa fa-angle-right"></i> 단체 문자 전송</h3>
        <div class="row mt">
            ...
            <div class="form-panel" style="margin-top:0; padding-bottom: 38px; border-radius: 0 0 10px 10px;">
              <form class="form-horizontal style-form" method="get">
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">발신번호</label>
                  <label class="col-sm-5 col-sm-5 control-label">02-123-4567</label>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">신규여부</label>
                  <div class="col-sm-10">
                    <label class="radio-inline">
                      <input type="radio" name="inRad" id="inlineRadio1" value="option1" > 일반
                    </label>
                    <label class="radio-inline">
                      <input type="radio" name="inRad" id="inlineRadio2" value="option2" checked> 광고 (광고용 메세지 발송시 어쩌구 정보통신망법)
                    </label>
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">수신</label>
                  <div class="col-sm-10">
                    <label class="radio-inline">
                      <input type="radio" name="inRad1" id="inlineRadio1" value="option1">
                       전체
                    </label>
                    <label class="radio-inline">
                      <input type="radio" name="inRad1" id="inlineRadio2" value="option2"checked>
                       마케팅수신동의
                    </label>
                    <label class="radio-inline">
                      <input type="radio" name="inRad1" id="inlineRadio2" value="option2">
                       마케팅수신 미동의
                    </label>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                   <textarea class="form-control" rows="10" style="width: 98%;" placeholder="내용을 입력하세요"></textarea>
                  </div>
                </div>
