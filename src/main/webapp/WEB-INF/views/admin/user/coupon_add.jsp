    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="active"><a id="coupon-mng" href="coupon_mng.admin">쿠폰 관리</a></li>
            ...
            <div class="form-panel" style="margin-top:0; padding-bottom: 38px; border-radius: 0 0 10px 10px;">
              <form class="form-horizontal style-form" method="get">
                <div class="form-group">
                  ...
                  <div class="col-sm-3 col-sm-3 col-sm-3">
                    <div class="dataTable-dropdown"><select class="dataTable-selector">
                        ...
                        <option value="id">오류보상</option>
                        <option value="name">신규가입</option>
                        <option value="name">친구추천</option>

                      </select>
                    </div>
                  </div>
                  <div class="col-sm-4 col-sm-4 col-sm-4">
                    <input type="text" class="form-control round-form" value="EV033001" disabled>
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">이벤트명</label>
                  <div class="col-sm-6">
                    <input class="form-control" type="text" placeholder="이벤트명">
                  </div>
                  <!--
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input class="form-control" type="text" placeholder="이벤트 설명">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <label class="radio-inline">
                      <input type="radio" name="inRad" id="inlineRadio1" value="option1"> 전액
                    </label>
                    <label class="radio-inline">
                      <input type="radio" name="inRad" id="inlineRadio2" value="option2" checked> 비율할인(%)
                    </label>
                    <label class="radio-inline">
                      <input type="radio" name="inRad" id="inlineRadio3" value="option3"> 금액할인(원)
                    </label>
                    
                      <input type="text" class="form-control round-form" value="10" style="width:150px; float: right;">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10"> 
                    <label class="radio-inline">
                      <input type="radio" name="inRad2" id="inlineRadio1" value="option1" checked> 일수
                    </label>
                    <label class="radio-inline">
                      <input type="radio" name="inRad2" id="inlineRadio2" value="option2" > 날짜
                    </label>
                    <input class="form-control round-form" type="text" placeholder="7" style="margin-left: 15px; width: 10%;display: inline-block;">일
                    <input class="form-control round-form" type="date" style="margin-left: 15px; width: 20%;display: inline-block;">
                ...
                <button type="button" onclick="window.history.back()" class="btn btn-theme" style="width:70px;float: right; margin-left: 10px;">뒤로</button>
                <button type="button" onclick="location.href='coupon_mng.html'" class="btn btn-theme" style="width:85px;float: right;">
                  쿠폰등록
                </button>
              </form>
            </div>
