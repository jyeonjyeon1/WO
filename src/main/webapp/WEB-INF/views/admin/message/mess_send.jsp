  ...
  <section id="container">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu dcjq-parent-li">
            ...
            <ul class="sub">
              ...
              <li class="active"><a id="mess-send" href="mess_send.admin">문자 전송</a></li>
    ...
    <%@ include file="../inc/admin_allmenu.jsp" %>
      <section class="wrapper site-min-height">
        <h3><i class="fa fa-angle-right"></i> 문자 전송</h3>
        <div class="row mt">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <label class="radio-inline">
                      <input type="radio" name="inRad" id="inlineRadio1" value="option1" checked> 일반
                    </label>
                    <label class="radio-inline">
                      <input type="radio" name="inRad" id="inlineRadio2" value="option2"> 광고 (광고용 메세지 발송시 어쩌구 정보통신망법)
                    </label>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input class="form-control" type="number" placeholder="01012344567">
                  </div>
                </div>
