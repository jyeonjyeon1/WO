        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu dcjq-parent-li">
            ...
            <ul class="sub">
              ...
              <li class="active"><a id="mess-hist" href="mess_hist.admin">문자 전송 이력</a></li>
            </ul>
          </li>
          <li class="sub-menu">
    ...
    <section id="main-content"> 
     <form class="allmenu-form">
      ...
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> 문자 전송이력</h3>
              ...
              <form class="form-horizontal style-form" method="get">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <label class="checkbox-inline">
                      <input type="checkbox" id="inlineCheckbox2" value="option2" checked> SMS
                    </label>
                    <label class="checkbox-inline">
                      <input type="checkbox" id="inlineCheckbox2" value="option2" > LMS
                    </label>
                  </div>
                </div>
                  ...
                  <table id="datatablesSimple">
                    <thead>
                      <tr>
                        ...
                        <th data-sortable="" style="width: 9%;"><a href="#" class="dataTable-sorter">유형</a></th>
                        <th data-sortable="" style="width: 9%;"><a href="#" class="dataTable-sorter">구분</a></th>
                        <th data-sortable="" style="width: 25%;"><a href="#" class="dataTable-sorter">내용</a></th>
                        <th data-sortable="" style="width: 9%;"><a href="#" class="dataTable-sorter">길이</a></th>
                        <th data-sortable="" style="width: 15%;"><a href="#" class="dataTable-sorter">전송일시</a></th>
                        <th data-sortable="" style="width: 9%;"><a href="#" class="dataTable-sorter">응답결과</a></th>
                      </tr>
                    </thead>
