        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu dcjq-parent-li">
            ...
            <ul class="sub">
              ...
              <li class="active"><a id="user-sales" href="user_sales.admin">사용자별 매출 통계</a></li>
...
<%@ include file="../inc/admin_allmenu.jsp" %> 
              ...
              <div class="modal-content">
                ...
                <div class="modal_wrapbody">
                  <div class="modal-body" style="padding-bottom:0;">
                    ...
                    <input type="text" id="" name="name" value="12" class="form-control">
                  </div>
                  <div class="modal-body" style="padding-bottom:0;">
                    <p style="margin-bottom:2px;">제목</p>
                    <input type="text" id="" name="name" value="워킹오더 5월 이벤트" class="form-control">
                  </div>
                  <div class="modal-body" style="padding-bottom:0;">
  ...
  배고파
                  ...
                  <div class="modal-body" style="padding-bottom:0;">
                    <input class="grey__button" type="file" onclick="" style="margin-right: 5px;">
                  </div>
    
                  <div class="modal-body" style="padding-bottom:0;">
                    <p style="margin-bottom:2px;">공개</p>
                  ...
                  <div class="modal-body">
                    ...
                    <label class="radio-inline">
                      <input type="radio" name="inRad4" id="inlineRadio1" value="option1"> 노출
                    </label>
                    <label class="radio-inline">
                      <input type="radio" name="inRad4" id="inlineRadio2" value="option2" checked> 비노출
                    </label>
                    <label class="radio-inline">
                      <input type="radio" name="inRad4" id="inlineRadio3" value="option3" checked> 예약
                    </label>
                    <label class="radio-inline">
                      2022.04.16 09:00:00
                    </label>
                ...
                <div class="modal-footer">
                  ...
                  <button onclick="location.href='notices_update.admin'" class="btn btn-theme" type="button">수정</button>
                </div>
              </div>
            </div>
          </div>
