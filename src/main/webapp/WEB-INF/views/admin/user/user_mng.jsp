      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu dcjq-parent-li">
            ...
            <ul class=" sub">
          <li class="active"><a id="user-mng" href="user_mng.admin">회원 관리</a></li>
            ...
            <div class="form-panel" style="margin-top:0; padding-bottom: 38px;">
              <form class="form-horizontal style-form" method="get">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input class="form-control" type="text" placeholder="01012345678" value="" style="width: 50%;">
                  </div>
                  <!--
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input class="form-control" type="text" placeholder="admin@walkingorder.com" style="width: 50%;">
                  </div>
                  <!--
                    id="focusedInput" 빨간 테두리
                    id="disabledInput" 못고치는거
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <label class="checkbox-inline">
                      <input type="checkbox" id="inlineCheckbox2" value="option2"> Naver
                    </label>
                    <label class="checkbox-inline">
                      <input type="checkbox" id="inlineCheckbox2" value="option2"> Google
                    </label>
                    <label class="checkbox-inline">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <label class="checkbox-inline">
                      <input type="checkbox" id="inlineCheckbox2" value="option2" checked> 활동
                    </label>
                    <label class="checkbox-inline">
                      <input type="checkbox" id="inlineCheckbox2" value="option2"> 휴면
                    </label>
                    <label class="checkbox-inline">
                      <input type="checkbox" id="inlineCheckbox2" value="option2"> 정지
                    </label>
                  </div>
                </div>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td><label class="checkbox-inline">
                          <input type="checkbox" id="inlineCheckbox1" value="option1" checked> S
                        </label>
                        <label class="checkbox-inline">
                          <input type="checkbox" id="inlineCheckbox2" value="option2"> E
                        </label>
                      </td>
                      <td>활동</td>
                    ...
                    <tr>
                      ...
                      <td><label class="checkbox-inline">
                        ...
                        <label class="checkbox-inline">
                          <input type="checkbox" id="inlineCheckbox2" value="option2" checked> E
                        </label>
                      </td>
                      <td>활동</td>
                      <td>2022.04.06 12:11:02</td>
