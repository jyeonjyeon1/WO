  ...
  <section id="container">
      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <li class="sub-menu dcjq-parent-li">
          ...
          <ul class="sub">
            ...
            <li class="active"><a id="store-menu" href="store_menu.admin">매장 메뉴 관리</a></li>
    ...
    <%@ include file="../inc/admin_allmenu.jsp" %>
      <section class="wrapper">
        <h3 style="margin-bottom: 5px;"><i class="fa fa-angle-right"></i> {매장명} 메뉴 수정</h3>
            ...
            <div class="form-panel" style="margin-top:0;  border-radius: 0 0 10px 10px;">
              <form class="form-horizontal style-form" method="get">
                <div class="row content-panel" style="border: none; box-shadow: none;padding: 0;margin:0 5px">
                  <!-- 메뉴 관리 / 품절 관리 -->
                  <div class="panel-heading col-lg-6 col-md-12 col-sm-12">
                    <ul class="nav nav-tabs nav-justified">
                      <li class="active">
                        <a data-toggle="tab" href="#menu">메뉴 관리</a>
                      </li>
                      <li>
                        <a data-toggle="tab" href="#sold_out">품절 설정</a>
                      </li>
                    </ul>
                  </div>
                  <!-- /panel-heading -->
                  <div class="panel-body col-lg-12" style="padding: 0 11px 11px 11px;">
                    <div class="tab-content">
                      ...
                      <div id="menu" class="tab-pane active no-padding">
                        <div class="row content-panel" style="border: none; box-shadow: none;padding: 0;margin:0 5px">
                          <!-- 메뉴편집 / 옵션편집 / 대표메뉴 / 메뉴모음컷 / 주문안내 -->
                          <div class="panel-heading col-lg-12 col-md-12 col-sm-12 no-padding"
                            style="margin-bottom: 5px;">
                            <ul class="nav nav-tabs nav-justified">
                              <li class="active">
                                <a data-toggle="tab" href="#menu_111">메뉴편집</a>
                              </li>
                              <li>
                                <a data-toggle="tab" href="#menu_222">옵션편집</a>
                              </li>
                              <li>
                                <a data-toggle="tab" href="#menu_333">대표메뉴</a>
                              </li>
                              <li>
                                <a data-toggle="tab" href="#menu_444">메뉴모음컷</a>
                              </li>
                              <li>
                                <a data-toggle="tab" href="#menu_555">주문안내</a>
                              </li>
                            </ul>
                          </div>
                          <!-- /panel-heading -->
                          <div class="panel-body col-lg-12">
                            <div class="tab-content">
                              <!-- 메뉴편집 -->
                              <div id="menu_111" class="tab-pane active">
                                <div class="row">
                                  <input type="button" id="add_menugroup_btn" value="메뉴그룹 추가" class="grey__button btn"
                                ...
                                <div class="row">
                                        ...
                                        <div id="collapse111" class="accordion-body collapse in">
                                          <div class="accordion-inner">
                                            <div class="row">
                                              <div class="one_menu_">
                                                <div class="col-md-2">
                                                  <img src="resources/assets/images/admin/friends/3.png" class="img-thumbnail"
                                                    style="margin-bottom: 3px;">
                                                  <input type="file" style="max-width: 100px;">
                                                </div>
                                                <div class="col-md-4">
                                                  <div class="form-group">
                                                    <label class="col-sm-4 col-sm-4 control-label"
                                                      style="font-size: 12px;">메뉴이름</label>
                                                    <div class="col-sm-8">
                                                      <input class="form-control" type="text" placeholder="메뉴이름"
                                                        style="height:25px;">
                                                    </div>
                                                  </div>
                                                  <div class="form-group">
                                                  ...
                                                  <div class="form-group" style="margin-bottom: 25px; padding-bottom:8px; border-bottom: 1px solid grey;">
                                                    <label class="col-sm-4 col-sm-4 control-label"
                                                      style="font-size: 12px;">메뉴이름</label>
                                                    <div class="col-sm-8">
                                                      <input class="form-control" type="text" placeholder="메뉴이름"
                                              ...
                                              <div class="one_menu_">
                                                <div class="col-md-2">
                                                  <img src="resources/assets/images/admin/friends/4444.png" class="img-thumbnail"
                                                    style="margin-bottom: 3px;">
                                                  <input type="file" style="max-width: 100px;">
                                                </div>
                                                <div class="col-md-4">
                                              ...
                                              <div class="one_menu_">
                                                <div class="col-md-2">
                                                  <img src="resources/assets/images/admin/friends/1.png" class="img-thumbnail"
                                                    style="margin-bottom: 3px;">
                                                  <input type="file" style="max-width: 100px;">
                                                </div>
                                                <div class="col-md-4">
                                              ...
                                              <div class="one_menu_">
                                                <div class="col-md-2">
                                                  <img src="resources/assets/images/admin/friends/2.png" class="img-thumbnail"
                                                    style="margin-bottom: 3px;">
                                                  <input type="file" style="max-width: 100px;">
                                                </div>
                                                <div class="col-md-4">
                                  ...
                                  <button type="button" onclick="window.history.back()" class="btn btn-theme"
                                    style="float: right; margin: 0 10px;">뒤로</button>
                                  <button type="button" onclick="location.href='store_menu.html'" class="btn btn-theme"
                              ...
                              <!-- /tab-pane -->
                              <!-- 옵션편집 -->
                              <div id="menu_222" class="tab-pane">
                                <div class="row">
                                  <div class="col-md-12 no-padding">
                                        ...
                                        <div id="collapseOne2" class="accordion-body collapse">
                                          <div class="accordion-inner">
                                            <div class="row" style="margin: 0;">
                                              <!-- 메뉴그룹1 -->
                                              <div class="menu_group col-md-12">
                                                <span>(New) 시즌메뉴 1</span>
                                              </div>
                                              <!-- 하나의 메뉴 -->
                                              <div class="col-md-4 menu_gulp">
                                                ...
                                                <input id="menu__1" type="button" class="sold_out_btn active"
                                                  value="품절">
                                              </div>
                                              <!-- /하나의메뉴 끝 -->
                                              ...
                                              <div class="col-md-4 menu_gulp">
                                                ...
                                                <input id="menu__2" type="button" class="sold_out_btn" value="품절">
                                              </div>
                                              <!-- /하나의메뉴 끝 -->
                                              ...
                                              <div class="col-md-4 menu_gulp">
                                                ...
                                                <input id="menu__3" type="button" class="sold_out_btn" value="품절">
                                              </div>
                                              <!-- /하나의메뉴 끝 -->
                                            ...
                                            <div class="row" style="margin: 0;">
                                              ...
                                              <div class="col-md-4 menu_gulp">
                                                ...
                                                <input id="menu__4" type="button" class="sold_out_btn" value="품절">
                                              </div>
                                              <!-- /하나의메뉴 끝 -->
                                              ...
                                              <div class="col-md-4 menu_gulp">
                                                ...
                                                <input id="menu__5" type="button" class="sold_out_btn active"
                                                  value="품절">
                                              </div>
                                              <!-- /하나의메뉴 끝 -->
                                              ...
                                              <div class="col-md-4 menu_gulp">
                                                ...
                                                <input id="menu__6" type="button" class="sold_out_btn" value="품절">
                                              </div>
                                              <!-- /하나의메뉴 끝 -->
                                          ...
                                          <div class="accordion-inner">
                                            <div class="row" style="margin: 0;">
                                              ...
                                              <div class="col-md-4 menu_gulp">
                                                ...
                                                <div class="menu_option">
                                                  <ul>
                                                    <li>ICE 리터: 6000 원<input id="menu__1" type="button"
                                                        class="sold_out_option_btn active" value="품절"></li>
                                                    <li>ICE 벤티: 5000 원<input id="menu__1" type="button"
                                                        class="sold_out_option_btn" value="품절"></li>
                                                    <li>HOT 벤티: 5000 원<input id="menu__1" type="button"
                                                        class="sold_out_option_btn" value="품절"></li>
                                                  </ul>
                                                </div>
                                              </div>
                              ...
                              <!-- /tab-pane -->
                              <!-- 대표메뉴 -->
                              <div id="menu_333" class="tab-pane">
                                <div class="row">
                                  <div class="col-md-12 no-padding">
                              ...
                              <!-- /tab-pane -->
                              <!-- 메뉴모음컷 -->
                              <div id="menu_444" class="tab-pane">
                                <div class="row">
                                  <div class="col-md-12 no-padding">
                              ...
                              <!-- /tab-pane -->
                              <!-- 옵션편집 -->
                              <div id="menu_555" class="tab-pane">
                                <div class="row">
                                  <div class="col-md-12 no-padding">
                      ...
                      <!-- /tab-pane -->
                      <!-- 품절설정 -->
                      <div id="sold_out" class="tab-pane">
                        <div class="row">
                          <div class="col-md-12">
                            <div class="accordion" id="accordion22">
                              <!-- 열리기1 -->
                              <div class="accordion-group">
                                <div class="accordion-heading">
                                  <a class="accordion-toggle collapsed"
                                    style="padding:0;margin:5px 0; border-top: 0;background-color: beige;"
                                    data-toggle="collapse" data-parent="#accordion22" href="#collapse21">
                                    <em class="glyphicon glyphicon-chevron-right icon-fixed-width"></em> 메뉴 품절
                                  </a>
                                </div>
                                  ...
                                  <div class="accordion-inner">
                                    <div class="row" style="margin: 0;">
                                      ...
                                      <div class="col-md-4 menu_gulp">
                                        ...
                                        <input id="menu__1" type="button" class="sold_out_btn active" value="품절">
                                      </div>
                                      <!-- /하나의메뉴 끝 -->
                                    ...
                                    <div class="row" style="margin: 0;">
                                      ...
                                      <div class="col-md-4 menu_gulp">
                                        ...
                                        <input id="menu__5" type="button" class="sold_out_btn active" value="품절">
                                      </div>
                                      <!-- /하나의메뉴 끝 -->
                              ...
                              <div class="accordion-group">
                                <div class="accordion-heading">
                                  <a class="accordion-toggle collapsed"
                                    style="padding:0;margin:5px 0;background-color: beige;" data-toggle="collapse"
                                    data-parent="#accordion22" href="#collapse22">
                                    <em class="glyphicon glyphicon-chevron-right icon-fixed-width"></em> 옵션 품절
                                  </a>
                                </div>
