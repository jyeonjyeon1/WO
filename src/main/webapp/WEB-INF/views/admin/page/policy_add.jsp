...
<%@ include file="../inc/admin_allmenu.jsp" %> 
    <!-- allmenu import -->
      ...
      <section class="wrapper site-min-height">
        <h3><i class="fa fa-angle-right"></i> 정책 등록</h3>
        <div class="row mt">
              ...
              <form class="form-horizontal style-form" method="get">
                <div class="form-group">
                  ...
                  <div class="col-sm-4 col-sm-4 col-sm-4">
                    <input type="text" id="t_code_input" class="form-control round-form" placeholder="정책코드" value="in_${current_max_code +1 }" disabled="disabled">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">정책명</label>
                  <div class="col-sm-6">
                    <input class="form-control" id="t_title_input" type="text" placeholder="정책명" value="">
                  </div>
                </div>
                <div class="form-group">
                  <div class="col-lg-12">
                    <textarea rows="8" id="t_content_input" class="form-control" placeholder="정책내용을 입력하세요"></textarea>
                  </div>
                </div>
                ...
                <button type="button" onclick="insertPolicy()" class="btn btn-theme"
