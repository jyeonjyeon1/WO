  ...
  <section id="container">
    ...
    <%@ include file="../inc/admin_allmenu.jsp" %>
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> 매장 관리</h3>
              ...
              <form class="form-horizontal style-form" method="get">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <label class="checkbox-inline">
                      <input type="checkbox" id="inlineCheckbox2" value="option2" checked> 영업중
                    </label>
                    <label class="checkbox-inline">
                      <input type="checkbox" id="inlineCheckbox2" value="option2"> 영업종료
                    </label>
                    <label class="checkbox-inline">
                      <input type="checkbox" id="inlineCheckbox2" value="option2"> 준비중
                    </label>
                    <label class="checkbox-inline">
                      <input type="checkbox" id="inlineCheckbox2" value="option2"> 폐점
                    </label>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <label class="radio-inline">
                      <input type="radio" name="inRad" id="inlineRadio2" value="option2"> 신규
                    </label>
                    <label class="radio-inline">
                      <input type="radio" name="inRad" id="inlineRadio3" value="option3"> 신규아님
                    </label>
                  </div>
                </div>
                ...
                <button type="button" onclick="location.href='store_mng_add.admin'" class="btn btn-theme"
              ...
              <table id="datatablesSimple">
                <thead>
                  <tr>
                    ...
                    <th data-sortable="" style="width: 10%;"><a href="#" class="dataTable-sorter">비번</a></th>
                    <th data-sortable="" style="width: 20%;"><a href="#" class="dataTable-sorter">주소</a></th>
                    <th data-sortable="" style="width: 11%;"><a href="#" class="dataTable-sorter">전화번호</a>
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <a data-toggle="modal" href="store_mng.html#myModal" class="btn btn-success btn-xs"><i
                          class="fa fa-eye"></i></a>
                      <button onclick="location.href='store_mng_update.admin?code=8868500662'"
                  ...
                  <tr>
                    ...
                    <td>
                      <a data-toggle="modal" href="store_mng.html#myModal" class="btn btn-success btn-xs"><i
                          class="fa fa-eye"></i></a>
                      <button onclick="location.href='store_mng_update.admin'" class="btn btn-primary btn-xs"><i
                          class="fa fa-pencil"></i></button>
                      <button type="button" onclick="javascript:deleteAlert();" class="btn btn-danger btn-xs"><i
