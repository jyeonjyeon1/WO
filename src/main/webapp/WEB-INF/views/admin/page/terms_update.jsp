              ...
              <form class="form-horizontal style-form" method="get">
                <div class="form-group">
                  ...
                  <div class="col-sm-4 col-sm-4 col-sm-4">
                    <input type="text" class="form-control round-form" placeholder="약관코드" value="TR001" >
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">약관명</label>
                  <div class="col-sm-6">
                    <input class="form-control" type="text" placeholder="약관명" value="이용약관">
                  </div>
                  <!--
                ...
                <div class="form-group">
                  <div class="col-lg-12">
                    <textarea rows="8" class="form-control" placeholder="약관내용을 입력하세요">
여러분을 환영합니다.
